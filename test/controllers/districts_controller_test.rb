...
class DistrictsControllerTest < ActionController::TestCase
  ...
  test "should create district" do
    assert_difference('District.count') do
      post :create, district: { name: @district.name, user_id: @district.user_id, valid_votes: @district.valid_votes, voters: @district.voters }
    end
  ...
  test "should update district" do
    patch :update, id: @district, district: { name: @district.name, user_id: @district.user_id, valid_votes: @district.valid_votes, voters: @district.voters }
    assert_redirected_to district_path(assigns(:district))
  end
